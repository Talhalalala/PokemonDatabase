...
export type PokemonQuery = { __typename?: 'Query', findManyPokemon: Array<{ __typename?: 'Pokemon', id: number, name: string, japanese_name: string, percentage_male: number, attack: number, defense: number, hp: number, sp_attack: number, sp_defense: number, speed: number, weight_kg: number, is_legendary: boolean, against_bug: number, against_dark: number, against_dragon: number, against_electric: number, against_fairy: number, against_fight: number, against_fire?: number | null, against_flying: number, against_ghost: number, against_grass?: number | null, against_ground: number, against_ice: number, against_normal?: number | null, against_poison: number, against_psychic: number, against_rock: number, against_steel: number, against_water?: number | null, base_egg_steps: number, base_happiness: number, base_total: number, capture_rate?: number | null, experience_growth: number, height_m: number, pokedex_number?: { __typename?: 'Pokedex', id: number } | null, types: Array<{ __typename?: 'PokemonTypes', type: { __typename?: 'Type', type: string } }>, generation: { __typename?: 'Generation', generation: number }, classification: { __typename?: 'Classification', classification: string }, abilities: Array<{ __typename?: 'PokemonAbilities', ability: { __typename?: 'Ability', ability: string } }> }> };
